...
def service_pipeline(encoder_mode=ENCODER_MODE, last_n=LAST_N, data_glob=DATA_GLOB):
...
class MetaModel:
    def __init__(self,num_classes=3, lambda_ewc=0.4, feature_dim: int = FEATURE_DIM):
    ...
    def build_lstm_encoder(self,seq_len=SEQ_LEN, num_feats=NUM_FEATS, feature_dim=FEATURE_DIM):
    ...
    def build_classifier(self,encoder, num_classes=NUM_CLASSES_NEW):
    ...
    def service_pipeline(self, encoder_mode=ENCODER_MODE, last_n=LAST_N, data_glob=DATA_GLOB):
