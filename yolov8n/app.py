...
def split_dataset():
    ...
    # 创建目录结构
    if os.path.exists(f"{app.config['DATASET_FOLDER']}/images/train"):
        shutil.rmtree(f"{app.config['DATASET_FOLDER']}/images/train")
    if os.path.exists(f"{app.config['DATASET_FOLDER']}/images/val"):
        shutil.rmtree(f"{app.config['DATASET_FOLDER']}/images/val")
    if os.path.exists(f"{app.config['DATASET_FOLDER']}/labels/train"):
        shutil.rmtree(f"{app.config['DATASET_FOLDER']}/labels/train")
    if os.path.exists(f"{app.config['DATASET_FOLDER']}/labels/val"):
        shutil.rmtree(f"{app.config['DATASET_FOLDER']}/labels/val")
